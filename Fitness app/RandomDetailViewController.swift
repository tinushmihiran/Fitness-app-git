...
class RandomDetailViewController: UIViewController {
    ...
    @objc func cardTapped(_ sender: UITapGestureRecognizer) {
        ...
        let cardDetailsVC = ExercisessDetailsViewController(exercise: selectedexercise)
    ...
    func addCardViews() {
        ...
        // Create a title label
           ...
           titleLabel.text = "All Random Exercises"
        ...
        for (index, exercises) in exercises.enumerated() {
            ...
            exercisedescriptionLabel.text = "exercisedifficulty: \(exercises.level)"
...
class ExercisessDetailsViewController: UIViewController {
    
    let exercise: Exercisess
    let goBackButton = UIButton()
    
    init(exercise: Exercisess) {
    ...
    override func viewDidLoad() {
        ...
        typeLabel.text = "details: \(exercise.details) details"
