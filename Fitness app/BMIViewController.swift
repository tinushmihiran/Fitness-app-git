...
//    }
//
//    @objc func cardViewTapped(_ gestureRecognizer: UITapGestureRecognizer) {
//        guard let index = gestureRecognizer.view?.tag else {
//            return
//        }
//
//        let selectedPlan = suggestedPlans[index]
//
//        let planDetailsViewController = PlanDetailsViewController()
//        planDetailsViewController.fitnessPlan = selectedPlan
//        navigationController?.pushViewController(planDetailsViewController, animated: true)
//    }
//
//
//
