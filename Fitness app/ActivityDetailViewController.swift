...
//        let distanceTitleLabel = UILabel(frame: CGRect(x: 16, y: 100, width: 200, height: 30))
//        distanceTitleLabel.text = "Distance"
//        view.addSubview(distanceTitleLabel)
//
//        let caloriesTitleLabel = UILabel(frame: CGRect(x: 16, y: 150, width: 200, height: 30))
//        caloriesTitleLabel.text = "Calories"
//        view.addSubview(caloriesTitleLabel)
//
//        let stepsTitleLabel = UILabel(frame: CGRect(x: 16, y: 200, width: 200, height: 30))
...
//        motionActivityManager.startActivityUpdates(to: OperationQueue.main) { [weak self] (activity: CMMotionActivity?) in
//            guard let activity = activity else { return }
//
//            DispatchQueue.main.async {
//                // Update the distance and calories based on the activity type
//                if activity.walking {
//                    self?.updateDistance(distance: 0.05) // Assuming 1 step = 0.05 km
//                    self?.updateCalories(calories: 5) // Assuming 1 step = 5 calories burned
//                } else if activity.running {
//                    self?.updateDistance(distance: 0.1) // Assuming 1 step = 0.1 km
//                    self?.updateCalories(calories: 10) // Assuming 1 step = 10 calories burned
//                }
//            }
//        }
//    }
...
//
//            DispatchQueue.main.async {
//                // Update the steps and distance based on the step count
//                let stepCount = pedometerData.numberOfSteps.intValue ?? 0
//                let distance = Double(stepCount) * 0.01 // Assuming 1 step = 0.01 km
//                let calories = Double(stepCount) * 0.5 // Assuming 1 step = 0.5 calories burned
//
//                self?.updateDistance(distance: distance)
//                self?.updateCalories(calories: calories)
//                self?.updateSteps(steps: stepCount)
//
//                // Calculate the duration and update the start date
...
//                } else {
//                    self?.startDate = pedometerData.endDate
//                }
//            }
//        }
//    }
...
//        let totalDistance = Double(distanceLabel.text ?? "0") ?? 0
//        let updatedDistance = totalDistance + distance
//        distanceLabel.text = String(format: "%.2f km", updatedDistance)
//    }
//
//    func updateCalories(calories: Double) {
//        let totalCalories = Double(caloriesLabel.text ?? "0") ?? 0
//        let updatedCalories = totalCalories + calories
//        caloriesLabel.text = String(format: "%.2f kcal", updatedCalories)
//    }
//
//    func updateSteps(steps: Int) {
//        let totalSteps = Int(stepsLabel.text ?? "0") ?? 0
//        let updatedSteps = totalSteps + steps
//        stepsLabel.text = "\(updatedSteps) steps"
//    }
//
//    override func viewWillDisappear(_ animated: Bool) {
//        super.viewWillDisappear(animated)
//
//        // Stop activity and step tracking when the view controller is no longer visible
